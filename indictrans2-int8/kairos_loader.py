...
INT8_WEIGHTS = (
    os.path.join(BASE_DIR, "indictrans2-int8.pth")
    if os.path.exists(os.path.join(BASE_DIR, "indictrans2-int8.pth"))
    else os.path.join(BASE_DIR, "indictrans2-int8", "indictrans2-int8.pth")
)
